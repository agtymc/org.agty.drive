...
@Controller
@RequestMapping("/cabinet/photos")
public class CabinetPhotosMvcController {

    private final CabinetMvcSupport cabinetMvcSupport;

    public CabinetPhotosMvcController(CabinetMvcSupport cabinetMvcSupport) {
    ...
    public String index(@RequestParam(name = "view", required = false) String viewMode,
                        ...
                        Model model) {
        cabinetMvcSupport.fillCabinetModel(model, userDetails, "photos", null, viewMode, sortMode, searchQuery, null, page, pageSize);
