...
@Controller
@RequestMapping("/cabinet/videos")
public class CabinetVideosMvcController {

    private final CabinetMvcSupport cabinetMvcSupport;

    public CabinetVideosMvcController(CabinetMvcSupport cabinetMvcSupport) {
    ...
    public String index(@RequestParam(name = "view", required = false) String viewMode,
                        ...
                        Model model) {
        cabinetMvcSupport.fillCabinetModel(model, userDetails, "videos", null, viewMode, sortMode, searchQuery, null, page, pageSize);
